...
internal class SvcReqRegister
{
    ...
    [JceMember(2)] public byte ConnType { get; set; }
    [JceMember(3)] public string Other { get; set; }
    [JceMember(4)] public int Status { get; set; }
    [JceMember(5)] public byte OnlinePush { get; set; }
    [JceMember(6)] public byte IsOnline { get; set; }
    [JceMember(7)] public byte IsShowOnline { get; set; }
    [JceMember(8)] public byte KickPC { get; set; }
    [JceMember(9)] public byte KickWeak { get; set; }
    [JceMember(10)] public long Timestamp { get; set; }
    [JceMember(11)] public long IOSVersion { get; set; }
    [JceMember(12)] public byte NetType { get; set; }
    [JceMember(13)] public string BuildVer { get; set; }
    [JceMember(14)] public byte RegType { get; set; }
    [JceMember(15)] public byte[] DevParam { get; set; }
    [JceMember(16)] public byte[] Guid { get; set; }
    [JceMember(17)] public int LocaleId { get; set; }
    [JceMember(18)] public byte SilentPush { get; set; }
    ...
    [JceMember(22)] public byte OpenPush { get; set; }
    ...
    [JceMember(34)] public byte IsSetStatus { get; set; }
    [JceMember(35)] public byte[] ServerBuf { get; set; }
    [JceMember(36)] public byte SetMute { get; set; }
