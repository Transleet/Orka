...
internal class MpFileNotify{
    [ProtoMember(1)] public  long  Sessionid { get; set; }
    [ProtoMember(2)] public  int  Operate { get; set; }
    @ProtoType(ProtoIntegerType.FIXED)  [ProtoMember(3)] public  int  Fixed32Ip { get; set; }
...
internal class NFCNotify{
    ...
    @ProtoType(ProtoIntegerType.FIXED)  [ProtoMember(4)] public  int  Fixed32Ip { get; set; }
