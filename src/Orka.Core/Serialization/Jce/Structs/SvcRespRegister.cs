...
internal class SvcRespRegister : IJceStruct
{
    ...
    [JceMember(2)] public byte ReplyCode { get; set; }
    [JceMember(3)] public string Result { get; set; }
    [JceMember(4)] public long ServerTime { get; set; }
    [JceMember(5)] public byte LogQQ { get; set; }
    [JceMember(6)] public byte NeedKik { get; set; }
    [JceMember(7)] public byte UpdateFlag { get; set; }
    [JceMember(8)] public long Timestamp { get; set; }
    [JceMember(9)] public byte CrashFlag { get; set; }
    ...
    [JceMember(14)] public byte LargeSeqUpdate { get; set; }
