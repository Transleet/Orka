...
internal class TroopMemberInfo : IJceStruct
{
    ...
    [JceMember(2)] public byte Age { get; set; }
    ...
    [JceMember(21)] public byte Concerned { get; set; }
    [JceMember(22)] public byte Shielded { get; set; }
    ...
    [JceMember(26)] public byte ApolloFlag { get; set; }
    ...
    [JceMember(33)] public byte RichCardNameVer { get; set; }
