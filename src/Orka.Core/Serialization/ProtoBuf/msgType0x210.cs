...
internal class Submsgtype0x26 {
    internal class Submsgtype0x26  {
        ...
        @ProtoType(ProtoIntegerType.SIGNED) [ProtoMember(3)] public  int  Sint32UnreadNum { get; set; }
        [ProtoMember(4)] public  AppTipNotify?  MsgAppTipNotify { get; set; }
        @ProtoType(ProtoIntegerType.SIGNED) [ProtoMember(5)] public  int  Sint32AlbumCnt { get; set; }
    } 
...
internal class Submsgtype0x31 {
    internal class Submsgtype0x31  {
        ...
        internal class MsgBody{
            ...
            @ProtoType(ProtoIntegerType.FIXED) [ProtoMember(4)] public  int  Time { get; set; }
        } 
    }
}
...
internal class Submsgtype0x4b {
    ...
    internal class MsgBody{
        ...
        @ProtoType(ProtoIntegerType.FIXED) [ProtoMember(5)] public  int  Time { get; set; }
...
internal class Submsgtype0x4e {
    internal class Submsgtype0x4e  {
        ...
        internal class GroupBulletin{
            ...
            [ProtoContract]
            internal class Oidb0x769.Content{
            [ProtoMember(1)] public  byte[]  Feedid { get; set; }
        [ProtoMember(2)] public  long  Uin { get; set; }
        @ProtoType(ProtoIntegerType.FIXED) [ProtoMember(3)] public  int  Time { get; set; }
    } 
}
...
internal class MsgBody{
    ...
    [ProtoMember(4)] public  Submsgtype0x4e.Submsgtype0x4e.GroupBulletin?  MsgGroupBulletin { get; set; }
} 
}
}
...
internal class Submsgtype0x54 {
    internal class Submsgtype0x54  {
        ...
        internal class MsgBody{
            ...
            [ProtoMember(3)] public  List<Cmd0x6f5.TaskInfo>  TaskList { get; set; }
        }  {
            [ProtoContract]
            internal class Cmd0x6f5.TaskInfo{
...
internal class Submsgtype0x90 {
    internal class SubMsgType0x90  {
        ...
        internal class MsgBody{
            ...
            [ProtoMember(2)] public  PushBody?  MsgBody { get; set; }
        } 
...
internal class Submsgtype0x9f {
    ...
    internal class MsgBody{
        ...
        [ProtoMember(5)] public  byte[]  ReceiverRichContent { get; set; }
        [ProtoMember(6)] public  byte[]  Authkey { get; set; }
        @ProtoType(ProtoIntegerType.SIGNED) [ProtoMember(7)] public  int  Sint32Sessiontype { get; set; }
...
internal class Submsgtype0xa1 {
    internal class Submsgtype0xa1  {
        ...
        internal class MsgBody{
            ...
            @ProtoType(ProtoIntegerType.FIXED) [ProtoMember(3)] public  int  Fixed32UpdateTime { get; set; }
...
internal class Submsgtype0xae {
    internal class SubMsgType0xae  {
        ...
        internal class PushPeopleMayKnow{
            @ProtoType(ProtoIntegerType.FIXED) [ProtoMember(1)] public  int  Fixed32Timestamp { get; set; }
...
internal class Submsgtype0xb3 {
    class SubMsgType0xb3 {
        ...
        internal class PushAddFrdNotify{
            ...
            @ProtoType(ProtoIntegerType.FIXED) [ProtoMember(3)] public  int  Fixed32Timestamp { get; set; }
            [ProtoMember(4)] public  string  Wording { get; set; }
...
internal class Submsgtype0xe5 {
    ...
    internal class S2CCallRecordChangePush{
        ...
        @ProtoType(ProtoIntegerType.FIXED) [ProtoMember(2)] public  long  Fixed64Timestamp { get; set; }
    } 
