...
internal class OIDB
{
    ...
    internal class Oidb0x88d
    {
        ...
        internal class GroupInfo
        {
            ...
            [ProtoMember(61)] public byte[]? IngPoidInfo { get; set; }
    ...
    internal class Oidb0x89a
    {
        ...
        internal class Groupinfo
        {
            [ProtoMember(1)] public int? groupExtAdmNum { get; set; }
            [ProtoMember(2)] public int? flag { get; set; }
            [ProtoMember(3)] public byte[]? ingGroupName { get; set; }
            [ProtoMember(4)] public byte[]? ingGroupMemo { get; set; }
            [ProtoMember(5)] public byte[]? ingGroupFingerMemo { get; set; }
            [ProtoMember(6)] public byte[]? ingGroupAioSkinUrl { get; set; }
            [ProtoMember(7)] public byte[]? ingGroupBoardSkinUrl { get; set; }
            [ProtoMember(8)] public byte[]? ingGroupCoverSkinUrl { get; set; }
            [ProtoMember(9)] public int? groupGrade { get; set; }
            [ProtoMember(10)] public int? activeMemberNum { get; set; }
            [ProtoMember(11)] public int? certificationType { get; set; }
            [ProtoMember(12)] public byte[]? ingCertificationText { get; set; }
            [ProtoMember(13)] public byte[]? ingGroupRichFingerMemo { get; set; }
            [ProtoMember(14)] public GroupNewGuidelinesInfo? stGroupNewguidelines { get; set; }
            [ProtoMember(15)] public int? groupFace { get; set; }
            [ProtoMember(16)] public int? addOption { get; set; }
            [ProtoMember(17)] public int? shutupTime { get; set; }
            [ProtoMember(18)] public int? groupTypeFlag { get; set; }
            [ProtoMember(19)] public List<byte[]> stringGroupTag { get; set; }
            [ProtoMember(20)] public GroupGeoInfo? msgGroupGeoInfo { get; set; }
            [ProtoMember(21)] public int? groupClassExt { get; set; }
            [ProtoMember(22)] public byte[]? ingGroupClassText { get; set; }
            [ProtoMember(23)] public int? appPrivilegeFlag { get; set; }
            [ProtoMember(24)] public int? appPrivilegeMask { get; set; }
            [ProtoMember(25)] public GroupExInfoOnly? stGroupExInfo { get; set; }
            [ProtoMember(26)] public int? groupSecLevel { get; set; }
            [ProtoMember(27)] public int? groupSecLevelInfo { get; set; }
            [ProtoMember(28)] public long? subscriptionUin { get; set; }
            [ProtoMember(29)] public int? allowMemberInvite { get; set; }
            [ProtoMember(30)] public byte[]? ingGroupQuestion { get; set; }
            [ProtoMember(31)] public byte[]? ingGroupAnswer { get; set; }
            [ProtoMember(32)] public int? groupFlagext3 { get; set; }
            [ProtoMember(33)] public int? groupFlagext3Mask { get; set; }
            [ProtoMember(34)] public int? groupOpenAppid { get; set; }
            [ProtoMember(35)] public int? noFingerOpenFlag { get; set; }
            [ProtoMember(36)] public int? noCodeFingerOpenFlag { get; set; }
            [ProtoMember(37)] public long? rootId { get; set; }
            [ProtoMember(38)] public int? msgLimitFrequency { get; set; }
        }
    ...
    internal class Oidb0xbe8
    {
        ...
        {
            [ProtoMember(1)] public int PopupResult1 { get; set; }
